...
\item \textbf{The reference list has been updated.} Two entries have been
replaced and the bibliography reformatted into the numbered IEEE style;
the removed and added entries are listed in the section ``Changes to the
Reference List.''
...
%==============================================================
\section*{Changes to the Reference List}
\addcontentsline{toc}{section}{Changes to the Reference List}

\begin{singlespace}
\color{changered}
\noindent\textbf{Removed:}
\begin{list}{}{%
  \setlength{\leftmargin}{1.5em}\setlength{\itemindent}{0pt}%
  \setlength{\listparindent}{0pt}\setlength{\topsep}{0.3\baselineskip}%
  \setlength{\itemsep}{0.4\baselineskip}\setlength{\parsep}{0pt}}
\item
M. Awada et al.,
``A new perspective on stress detection: An automated approach for detecting eustress and distress,''
IEEE Transactions on Affective Computing, vol. 15, no. 3, pp. 1153--1165, 2023.
\item
...
\vspace{0.5\baselineskip}
\noindent\textbf{Added in their place:}
\begin{list}{}{%
  \setlength{\leftmargin}{1.5em}\setlength{\itemindent}{0pt}%
  \setlength{\listparindent}{0pt}\setlength{\topsep}{0.3\baselineskip}%
  \setlength{\itemsep}{0.4\baselineskip}\setlength{\parsep}{0pt}}
...
Proc. 3rd Cognitive Models and Artificial Intelligence Conference (AICCONF), pp. 1--6, 2025.
\end{list}
\end{singlespace}
...
reported in Table~I. The reference list has also been updated, as set out
in the section ``Changes to the Reference List.''
